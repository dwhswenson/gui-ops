...
PACKAGES=['gui_paths', 'gui_paths.tests']

# This DESCRIPTION is only used if a README.rst hasn't been made from the
# markdown version
DESCRIPTION="""
"""
SHORT_DESCRIPTION="GUI for OpenPathSampling"
...
if __name__ == "__main__":
    write_version_py(os.path.join('gui_paths', 'version.py'))
    setup(
        name="gui_paths",
        ...
        version=PACKAGE_VERSION,
        license="MIT",
        url="http://github.com/dwhswenson/gui-ops",
        packages=PACKAGES,
